...
class SignalCardSharingWidget extends StatefulWidget {
  SignalCardSharingWidget({Key? key, required this.signal}) : super(key: key);
  final Signal signal;

  @override
  State<SignalCardSharingWidget> createState() => _SignalCardSharingWidgetState();
}

class _SignalCardSharingWidgetState extends State<SignalCardSharingWidget> {
            ...
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  Spacer(),
                  Text(widget.signal.ltpPrice.toString()),
                ]),
                SizedBox(height: 8),
                Row(children: [
                  Text(
